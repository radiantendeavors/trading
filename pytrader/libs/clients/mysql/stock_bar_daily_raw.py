"""!
@package pytrader.libs.clients.mysql.stock_bar_daily_raw
...
@file pytrader/libs/clients/mysql/stock_bar_daily_raw.py
"""
# System Libraries
import pymysql
...
#
# ==================================================================================================
class StockBarDailyRaw(mysql.MySQLDatabase):

    def __init__(self):
        self.table_name = "stock_bar_daily_raw"
        super().__init__()
    ...
    def insert(self, ticker, date_time, p_open, p_high, p_low, p_close,
        ...
        if item:
            ...
            sql = """
            INSERT INTO `stock_bar_daily_raw`

"""!
@package pytrader.libs.dbclient.etfs

Provides the etf classes for the database client
...
from sqlalchemy import Column, Date, DateTime, ForeignKey, Float, Integer, String, Boolean
